...
CREATE TABLE sat_alerta_temprana (
    ...
    nombre_medio_prensa VARCHAR(250),
    ...
    fotografia_prensa VARCHAR,
    nombre_medio_radio VARCHAR(250),
    canal_radio VARCHAR(200),
    nombre_programa_radio VARCHAR(250),
    fecha_emision_radio TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
    titulo_redes VARCHAR(250) NOT NULL,
    nombre_red_social VARCHAR(250),
    url_red_social VARCHAR,
    fecha_pub_red_social TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    pantalla_red_social VARCHAR,
    nombre_colectivo VARCHAR(250),
    nombre_contacto_colectivo VARCHAR(250),
    telefono_colectivo VARCHAR(50),
    nombre_organismo VARCHAR(250),
    nombre_contacto_organismo VARCHAR(250),
    ...
    poblacion_afectada VARCHAR(100) NOT NULL,
    ...
    analisis VARCHAR,
    notificar NUMERIC, -- Unidades administrativas
    texto_mensaje TEXT,
    analizada boolean,
    fecha_ing_reg TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    fecha_mod_reg TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
